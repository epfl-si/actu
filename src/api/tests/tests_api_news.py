...
class NewsAPITests(TestCase):
    ...
    def setUp(self):
        ...
        self.other_format = NewsFormat.objects.create(
            label_en="Other format",
            label_fr="Autre format",
    ...
    def test_list_news_by_entity(self):
        ...
        url = reverse("news-list", kwargs={"version": "v1"})
        response = self.client.get(url, {"entity_id": self.entity.pk})
    ...
    def test_search_combines_with_entity_filter(self):
        ...
        response = self.client.get(
            url,
            {"entity_id": self.entity.pk, "search": "energy"},
        )
    ...
    def test_filters_by_multiple_entities(self):
        ...
        response = self.client.get(
            url,
            {
                "entity_id": [self.entity.pk, self.other_entity.pk],
            },
        )
    ...
    def test_filters_by_multiple_entities_with_invalid_id_returns_empty(self):
        self._create_news(
            title="Entity news",
            entity=self.entity,
            published_at=self.now,
        ...
        response = self.client.get(
            url,
            {
                "entity_id": [self.entity.pk, "not-an-id"],
            },
        )
